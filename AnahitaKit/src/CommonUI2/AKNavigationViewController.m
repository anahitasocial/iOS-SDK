...
//        _cellGradient = AKAddGradientToView(self, HEXCOLOR(0xeeeeee), AKDarkerUIColor(HEXCOLOR(0xeeeeee)));
    }    
    return self;
...
//    _cellGradient.frame  = self.bounds;
}
...
@interface AKNavigationViewController () <UITableViewDelegate>

@property(nonatomic,readonly) NIMutableTableViewModel* tableModel;

@end

@implementation AKNavigationViewController
{
    //table model
